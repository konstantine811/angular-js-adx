...
angular.module("components/legal/legal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("components/legal/legal.tpl.html",
    ...
    "                                    <div class=\"txt--indent-small\">\n" +
    "                                        <p class=\"txt-middle txt-black\">\n" +
    "                                            You acknowledge and agree that ADx Healthcare has the right to monitor any use of its systems at any time and to maintain copies documenting such monitoring. Our Privacy Policy sets forth the only expectations of privacy any individual should have in terms of usage of the ADx Healthcare Services, website, or other systems. Please refer to our Privacy Policy, available here [ADD LINK], to read about data protection related to your information.\n" +
    "                                        </p>\n" +
    "                                    </div>\n" +
    "\n" +
    "                                    <div class=\"txt--indent-small\">\n" +
