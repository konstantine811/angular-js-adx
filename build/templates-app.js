...
angular.module("components/results/pages/result-p2.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("components/results/pages/result-p2.tpl.html",
    ...
    "          <div class=\"txt--indent-small\">\n" +
    "            <p class=\"txt txt-black\">\n" +
    "              <span ng-if=\"results.name === 'e2/e3'\">You are amongst the approximately 73% of the US population that does not carry a copy of the ApoE-e4 variant.  It is estimated that only about 27% of the total US population carries at least one copy of the ApoE-e4 variant.50,51</span>\n" +
    "              <span ng-if=\"results.name === 'e2/e2'\">You are amongst the approximately 73% of the US population that does not carry a copy of the ApoE-e4 variant.  It is estimated that only about 27% of the total US population carries at least one copy of the ApoE-e4 variant.50,51</span>\n" +
    "              <span ng-if=\"results.name === 'e3/e3'\">You are amongst the approximately 73% of the US population that does not carry a copy of the ApoE-e4 variant.  It is estimated that only about 27% of the total US population carries at least one copy of the ApoE-e4 variant.50,51</span>\n" +
    "              <span ng-if=\"results.name === 'e2/e4'\">It is estimated that about 27% of the total US population carries at least one copy of the ApoE-e4 variant.50,51</span>\n" +
    "              <span ng-if=\"results.name === 'e3/e4'\">It is estimated that about 27% of the total US population carries at least one copy of the ApoE-e4 variant.50,51</span>\n" +
    "              <span ng-if=\"results.name === 'e4/e4'\">It is estimated that about 27% of the total US population carries at least one copy of the ApoE-e4 variant.50,51</span>\n" +
    "            </p>\n" +
    "          </div>\n" +
    "        </div>\n" +
    "        \n" +
