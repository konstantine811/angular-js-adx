...
angular.module("components/home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("components/home/home.tpl.html",
    ...
    "            <a ng-href=\"{{ globals.order_url_pdp }}\" target=\"_blank\" jq-slider class=\"button-border-rounded\">Order test</a>\n" +
    "          </div>\n" +
    "        </div>\n" +
    ...
    "            <a ng-href=\"{{ globals.order_url_pdp }}\" target=\"_blank\" class=\"bt-round bt-round--blue-dark\">Order</a>\n" +
    "          </div>\n" +
    "        </div>\n" +
    "      </div>\n" +
    "    </div>\n" +
...
angular.module("components/legal/legal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("components/legal/legal.tpl.html",
    ...
    "                        </div>\n" +
    "                        <div class=\"section__wrap\">\n" +
    "                            <h3 class=\"txt-blue txt-center anim-content-transition\">Product Consent</h3>\n" +
    "                            <div class=\"txt__wrap\">\n" +
    "                                <div class=\"row\">\n" +
    "                                    <div class=\"col-sm-6 anim-content-transition\">\n" +
    "                                        <h6 class=\"txt-middle txt-black txt-bold txt--indent-small\">Informed Consent</h6>\n" +
    "                                        <div class=\"txt-middle txt-black txt--indent-small\">\n" +
    ...
    "                                        </div>\n" +
    "\n" +
    "                                        <h6 class=\"txt-middle txt-black txt-bold txt--indent-small\">Description of Product</h6>\n" +
    "                                        <div class=\"txt-middle txt-black txt--indent-small\">\n" +
    ...
    "                                        </div>\n" +
    "\n" +
    "                                        <h6 class=\"txt-middle txt-black txt-bold txt--indent-small\">Genetic Conditions</h6>\n" +
    "                                        <div class=\"txt-middle txt-black txt--indent-small\">\n" +
    ...
    "                                        </div>\n" +
    "\n" +
    "                                        <h6 class=\"txt-middle txt-black txt-bold txt--indent-small\">Risks and Considerations</h6>\n" +
    "                                        <div class=\"txt--indent-small\">\n" +
    ...
    "                                    </div>\n" +
    "                                    <div class=\"col-sm-6\">\n" +
    "                                        <h6 class=\"txt-middle txt-black txt-bold txt--indent-small\">Genetic Information Non-Disclosure Act (GINA)</h6>\n" +
    "                                        <div class=\"txt-middle txt-black txt--indent-small\">\n" +
    "                                            GINA was signed into law in the United States in 2008 to protect against discrimination based on genetic information by employers and health insurance companies for employment and coverage issues. You should be careful about sharing your Genetic Information with others as Genetic Information that you share with others could be used against your interests. In addition, GINA does not protect against discrimination by, for example, long-term health, life, and disability insurance providers, or the military. Some, but not all, states and other jurisdictions have laws that protect individuals with regard to their Genetic Information. You may want to consult a lawyer to understand the extent of legal protection of your Genetic Information before you share it with anybody.\n" +
    "                                        </div>\n" +
    "                                        <div class=\"txt-middle txt-black txt--indent-small\">\n" +
    ...
    "                                        </div>\n" +
    "\n" +
    "                                        <h6 class=\"txt-middle txt-black txt-bold txt--indent-small\">Approval and Counsel</h6>\n" +
    "                                        <div class=\"txt-middle txt-black txt--indent-small\">\n" +
    ...
    "                                        </div>\n" +
    "\n" +
    "                                        <h6 class=\"txt-middle txt-black txt-bold txt--indent-small\">Consent</h6>\n" +
    "                                        <div class=\"txt-middle txt-black txt--indent-small\">\n" +
...
angular.module("components/results/pages/prePurchase.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("components/results/pages/prePurchase.tpl.html",
    ...
    "                  </div>\n" +
    "                  <div class=\"button__wrap button--center\">\n" +
    "                    <a ng-href=\"{{ globals.order_url_pdp }}\" target=\"_blank\" class=\"bt-round bt-round--large bt-round--blue-dark\">Order</a>\n" +
    "                  </div>\n" +
    "                </div>\n" +
    "              </div>\n" +
    "            </div>\n" +
...
angular.module("components/results/pages/result-p2.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("components/results/pages/result-p2.tpl.html",
    ...
    "        <div ng-if=\"gender == 'M' && results.name == 'e2/e2'\" class=\"img\" ng-include=\"'./assets/images/charts/e2e2-male-chart.svg'\"></div>\n" +
    "        <div ng-if=\"gender == 'M' && results.name == 'e2/e4'\" class=\"img\" ng-include=\"'./assets/images/charts/e2e4-male-chart.svg'\"></div>\n" +
    "        <div ng-if=\"gender == 'M' && results.name == 'e2/e3'\" class=\"img\" ng-include=\"'./assets/images/charts/e2e3-male-chart.svg'\"></div>\n" +
    "        <div ng-if=\"gender == 'M' && results.name == 'e3/e3'\" class=\"img\" ng-include=\"'./assets/images/charts/e3e3-male-chart.svg'\"></div>\n" +
    "        <div ng-if=\"gender == 'M' && results.name == 'e3/e4'\" class=\"img\" ng-include=\"'./assets/images/charts/e3e4-male-chart.svg'\"></div>\n" +
    "        <div ng-if=\"gender == 'M' && results.name == 'e4/e4'\" class=\"img\" ng-include=\"'./assets/images/charts/e4e4-male-chart.svg'\"></div>\n" +
    "\n" +
    "        <div ng-if=\"gender == 'F' && results.name == 'e2/e2'\" class=\"img\" ng-include=\"'./assets/images/charts/e2e2-female-chart.svg'\"></div>\n" +
    "        <div ng-if=\"gender == 'F' && results.name == 'e2/e4'\" class=\"img\" ng-include=\"'./assets/images/charts/e2e4-female-chart.svg'\"></div>\n" +
    "        <div ng-if=\"gender == 'F' && results.name == 'e2/e3'\" class=\"img\" ng-include=\"'./assets/images/charts/e2e3-female-chart.svg'\"></div>\n" +
    "        <div ng-if=\"gender == 'F' && results.name == 'e3/e3'\" class=\"img\" ng-include=\"'./assets/images/charts/e3e3-female-chart.svg'\"></div>\n" +
    "        <div ng-if=\"gender == 'F' && results.name == 'e3/e4'\" class=\"img\" ng-include=\"'./assets/images/charts/e3e4-female-chart.svg'\"></div>\n" +
    "        <div ng-if=\"gender == 'F' && results.name == 'e4/e4'\" class=\"img\" ng-include=\"'./assets/images/charts/e4e4-female-chart.svg'\"></div>\n" +
    "      </div>\n" +
    "      <div class=\"section__wrap-md section__wrap-md--sm\">\n" +
    "        <p class=\"txt txt-black\">\n" +
    ...
    "        <div class=\"col-sm-12\">\n" +
    "          <div class=\"chart__wrap\">\n" +
    "            <div ng-if=\"gender == 'M' && results.name == 'e2/e2'\" class=\"img\" ng-include=\"'./assets/images/charts/e2e2-male-table.svg'\"></div>\n" +
    "            <div ng-if=\"gender == 'M' && results.name == 'e2/e4'\" class=\"img\" ng-include=\"'./assets/images/charts/e2e4-male-table.svg'\"></div>\n" +
    "            <div ng-if=\"gender == 'M' && results.name == 'e2/e3'\" class=\"img\" ng-include=\"'./assets/images/charts/e2e3-male-table.svg'\"></div>\n" +
    "            <div ng-if=\"gender == 'M' && results.name == 'e3/e3'\" class=\"img\" ng-include=\"'./assets/images/charts/e3e3-male-table.svg'\"></div>\n" +
    "            <div ng-if=\"gender == 'M' && results.name == 'e3/e4'\" class=\"img\" ng-include=\"'./assets/images/charts/e3e4-male-table.svg'\"></div>\n" +
    "            <div ng-if=\"gender == 'M' && results.name == 'e4/e4'\" class=\"img\" ng-include=\"'./assets/images/charts/e4e4-male-table.svg'\"></div>\n" +
    "\n" +
    "            <div ng-if=\"gender == 'F' && results.name == 'e2/e2'\" class=\"img\" ng-include=\"'./assets/images/charts/e2e2-female-table.svg'\"></div>\n" +
    "            <div ng-if=\"gender == 'F' && results.name == 'e2/e4'\" class=\"img\" ng-include=\"'./assets/images/charts/e2e4-female-table.svg'\"></div>\n" +
    "            <div ng-if=\"gender == 'F' && results.name == 'e2/e3'\" class=\"img\" ng-include=\"'./assets/images/charts/e2e3-female-table.svg'\"></div>\n" +
    "            <div ng-if=\"gender == 'F' && results.name == 'e3/e3'\" class=\"img\" ng-include=\"'./assets/images/charts/e3e3-female-table.svg'\"></div>\n" +
    "            <div ng-if=\"gender == 'F' && results.name == 'e3/e4'\" class=\"img\" ng-include=\"'./assets/images/charts/e3e4-female-table.svg'\"></div>\n" +
    "            <div ng-if=\"gender == 'F' && results.name == 'e4/e4'\" class=\"img\" ng-include=\"'./assets/images/charts/e4e4-female-table.svg'\"></div>\n" +
    "          </div>\n" +
    "          <div class=\"section__wrap-md section__wrap-md--sm\">\n" +
    "            <p class=\"txt txt-black\">\n" +
...
angular.module("shared/header/header.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("shared/header/header.tpl.html",
    ...
    "            </div>\n" +
    "            <div class=\"button__purchase\">\n" +
    "              <a ng-class=\"{'ng-hide': logged}\" ng-href=\"{{ globals.order_url_pdp }}\" target=\"_blank\" class=\"bt-round bt-round--sm bt-round--header bt-round--blue-dark\">Order</a>\n" +
